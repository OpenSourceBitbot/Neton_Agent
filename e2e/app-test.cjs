// yxpil · NETON — 应用级极端测试（app-test.cjs）：认证闸门 / 流式 / 输入模拟 / 工具回路 / 边界
// 针对活实例 127.0.0.1:8600（NETON_DATA_DIR=/tmp/NETON-e2e），provider=mock-ai:9901
const http = require("http");
const KEY = "NETON_e2e_client_key_0000000000000000";
const PW = "87654321";
